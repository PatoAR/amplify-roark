...
export const EMAIL_TRANSLATIONS: Record<string, EmailTemplate> = {
  es: {
    ...
    valueProposition: 'Es la potencia de una <b>terminal de noticias financiera</b>, pero 100% personalizable y abierta a profesionales como tú.',
    invitation: 'Te invito a crear tu <b>cuenta gratuita</b> y configurar Perkins de acuerdo con tus preferencias aquí: https://www.perkinsintel.com',
    ...
    signature: 'Saludos cordiales,\n\n<b>Equipo Perkins Intelligence</b>\ninfo@perkinsintel.com',
  },
  en: {
    subject: 'Invitation to Perkins Intelligence',
    greeting: 'Hello {firstName},',
    intro: 'I\'m writing because we\'re launching the <b>professional version of Perkins Intelligence.</b>',
    ...
    valueProposition: 'It\'s the power of a <b>financial news terminal</b>, but 100% customizable and open to professionals like you.',
    invitation: 'I invite you to create your <b>free account</b> and configure Perkins according to your preferences here: https://www.perkinsintel.com',
    ...
    signature: 'Best regards,\n\n<b>Perkins Intelligence Team</b>\ninfo@perkinsintel.com',
  },
  pt: {
    subject: 'Convite para Perkins Intelligence',
    greeting: 'Olá {firstName},',
    intro: 'Estou escrevendo porque estamos lançando a <b>versão profissional do Perkins Intelligence.</b>',
    ...
    valueProposition: 'É o poder de um <b>terminal de notícias financeiras</b>, mas 100% personalizável e aberto a profissionais como você.',
    invitation: 'Convido você a criar sua <b>conta gratuita</b> e configurar o Perkins de acordo com suas preferências aqui: https://www.perkinsintel.com',
    ...
    signature: 'Atenciosamente,\n\n<b>Equipe Perkins Intelligence</b>\ninfo@perkinsintel.com',
  },
};
