...
// Let CloudFormation generate a unique rule name automatically based on stack name and logical ID
// This ensures uniqueness across deployments and prevents "AlreadyExists" errors
