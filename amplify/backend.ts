...
// Since function is in data stack, access tables from data stack resources
...
// This ensures proper cross-stack references work correctly
...
// GSI name follows Amplify Gen 2 naming convention: ModelName + FieldName
lambdaFunction.addEnvironment('CONTACT_TABLE_GSI_NAME', 'SESCampaignContactSent_Status');
...
// Function is in data stack, so Function URL should be in the same stack
